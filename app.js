...
const svgIcons = [
    // Nature & Essentials
    { name: 'Night', path: 'M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z' },
    { name: 'Water', path: 'M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z' },
    { name: 'Location', path: 'M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6z' },

    // Productivity
    { name: 'Reading', path: 'M4 19.5A2.5 2.5 0 0 1 6.5 17H20 M4 19.5A2.5 2.5 0 0 0 6.5 22H20 M20 22V2H6.5A2.5 2.5 0 0 0 4 4.5v15z M8 7h8 M8 11h8' },
    { name: 'Planning', path: 'M16 2v4 M8 2v4 M3 10h18 M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z' },
    { name: 'Focus', path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z' },
    { name: 'Goals', path: 'M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z' },

    // Learning & Growth
    { name: 'Study', path: 'M4 19.5A2.5 2.5 0 0 1 6.5 17H20 M4 19.5A2.5 2.5 0 0 0 6.5 22H20 M20 22V2H6.5A2.5 2.5 0 0 0 4 4.5v15z M12 6v6l4-2' },
    ...
    { name: 'Research', path: 'M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16z M21 21l-4.35-4.35' },
    { name: 'Skills', path: 'M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z' },

    // Work & Career
    { name: 'Work', path: 'M20 7h-4V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2H4a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zM10 5h4v2h-4V5z' },
    { name: 'Meeting', path: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75' },
    { name: 'Email', path: 'M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6' },
    { name: 'Call', path: 'M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z' },
    { name: 'Presentation', path: 'M2 3h20v14H2z M8 21l4-7 4 7' },

    // Social & Relationships
    { name: 'Family', path: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75' },
    { name: 'Friends', path: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75' },
    { name: 'Communication', path: 'M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z' },
    { name: 'Date', path: 'M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z' },
    { name: 'Community', path: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75' },

    // Finance
    { name: 'Budget', path: 'M12 2v20 M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6' },
    { name: 'Investment', path: 'M23 6l-9.5 9.5-5-5L1 18 M23 6h-7 M23 6v7' },
    { name: 'Shopping', path: 'M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z M3 6h18 M16 10a4 4 0 0 1-8 0' },
    { name: 'Bills', path: 'M21 4H3a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z M1 10h22' },

    // Home & Living
    { name: 'Cleaning', path: 'M15 2v5a3 3 0 0 0 3 3h5 M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z M10 10.3L14 14 M14 10l-4 4' },
    { name: 'Cooking', path: 'M6 13.87A4 4 0 0 1 7.41 6a5.11 5.11 0 0 1 1.05-1.54 5 5 0 0 1 7.08 0A5.11 5.11 0 0 1 16.59 6 4 4 0 0 1 18 13.87V21H6z M9 21v-8h6v8' },
    { name: 'Gardening', path: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z' },
    { name: 'Laundry', path: 'M21 2H3v20h18zM6 6h2v2H6zm4 0h2v2h-2zm-5 6a5 5 0 1 0 10 0' },
    { name: 'Organization', path: 'M10 3H3v7h7V3z M21 3h-7v7h7V3z M21 14h-7v7h7v-7z M10 14H3v7h7v-7z' },

    // Transportation
    { name: 'Driving', path: 'M18.92 5.01C18.72 4.42 18.16 4 17.5 4h-11c-.66 0-1.21.42-1.42 1.01L3 11v9a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1h12v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-9zM6.5 15A1.5 1.5 0 1 1 8 13.5 1.5 1.5 0 0 1 6.5 15zM17.5 15a1.5 1.5 0 1 1 1.5-1.5 1.5 1.5 0 0 1-1.5 1.5zM5 10l1.5-4.5h11L19 10z' },
    { name: 'Walking', path: 'M13.5 5.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4z M9.8 8.9L7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3.7 3.3 1.6 5.5 1.6v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6a2 2 0 0 0-1.7-1c-.3 0-.5.1-.8.1l-5.2 2.3V13h2V9.6l1.8-.7z' },
    { name: 'Cycling', path: 'M5 18a5 5 0 1 0 0-10 5 5 0 0 0 0 10z M19 18a5 5 0 1 0 0-10 5 5 0 0 0 0 10z M15.5 5.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4z M12 6l-2 4 M7 14l5-8 5 4 M19 10l-3-6' },
    { name: 'Travel', path: 'M3 18h18 M4.5 9.5l7.5-7 7.5 7 M9 22v-9 M15 22v-9' },

    // Entertainment & Hobbies
    { name: 'Music', path: 'M9 18V5l12-2v13 M9 18a3 3 0 1 1-6 0 3 3 0 0 1 6 0z M21 16a3 3 0 1 1-6 0 3 3 0 0 1 6 0z' },
    { name: 'Gaming', path: 'M20 6h-5.2l-1-2H10.2l-1 2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z M8 14H6v-2h2v2zm0-3H6V9h2v2zm3 3h2v-2h-2v2zm8 0h-2v-2h-2v-2h2V9h2v5z' },
    { name: 'Movies', path: 'M19.82 2H4.18A2.18 2.18 0 0 0 2 4.18v15.64A2.18 2.18 0 0 0 4.18 22h15.64A2.18 2.18 0 0 0 22 19.82V4.18A2.18 2.18 0 0 0 19.82 2zM7 2v20M17 2v20M2 12h20M2 7h5M2 17h5M17 17h5M17 7h5' },
    { name: 'Photography', path: 'M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z M12 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8z' },
    { name: 'Art', path: 'M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0zM12 22v-6 M12 22a10 10 0 0 0 9.54-6.9' },

    // Self-Care & Wellness
    { name: 'Yoga', path: 'M12 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4z M10 22v-7 M14 22v-7 M8 10l4 12 4-12 M5 15h14' },
    { name: 'Skincare', path: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z M12 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6z' },

    // Mind & Creativity
    { name: 'Journal', path: 'M4 19.5A2.5 2.5 0 0 1 6.5 17H20 M4 19.5A2.5 2.5 0 0 0 6.5 22H20 M20 22V2H6.5A2.5 2.5 0 0 0 4 4.5v15z M8 6h8 M8 10h8 M8 14h5' },
    { name: 'Drawing', path: 'M12 19l7-7 3 3-7 7-3-3z M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z M2 2l7.586 7.586 M11 13a2 2 0 1 0 0-4 2 2 0 0 0 0 4z' },
    { name: 'Brainstorm', path: 'M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z M8.5 14.5l2 2 4-4' },
    { name: 'Ideas', path: 'M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z M12 22v-6 M9 17h6 M9 14h6' },

    // Digital Life
    { name: 'Video Call', path: 'M23 7l-7 5 7 5V7z M16 5H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1z' },
    { name: 'World', path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M2 12h20 M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z' },

    // Nature & Environment
    { name: 'Outdoors', path: 'M3 18h18 M4 18L12 3l8 15 M9 14h6' },

    // Time Management
    { name: 'Time', path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 6v6l4 2' },
    { name: 'Timer', path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 6v6l4 2 M10 2h4' },
    { name: 'Routine', path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 6v6h4.5' },
    { name: 'Morning', path: 'M12 2v2 M12 20v2 M4.93 4.93l1.41 1.41 M17.66 17.66l1.41 1.41 M2 12h2 M20 12h2 M6.34 17.66l-1.41 1.41 M19.07 4.93l-1.41 1.41 M12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10z' },

    // Health Tracking
    { name: 'Weight', path: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z M9.5 9a2.5 2.5 0 0 1 5 0c0 4.5-5 4.5-5 9' },
    { name: 'Mood', path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M8 14s1.5 2 4 2 4-2 4-2 M9 9h.01 M15 9h.01' },

    // Food & Nutrition
    { name: 'Coffee', path: 'M18 8h1a4 4 0 0 1 0 8h-1 M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4z M6 1v3 M10 1v3 M14 1v3' },

    // Mental Health
    { name: 'Abort', path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M4.93 4.93l14.14 14.14' },

    // Miscellaneous Life Actions
    { name: 'Thumbs-up', path: 'M7 22V11 M1 14l3-3 7 1 4-8 2 1-3 11-8-1-4 3-1-4z M21 11h-4l1-7-6 7h4l-1 7z' },
    { name: 'Sleep', path: 'M17 7L7 17 M8 17h9v-9' },
    { name: 'Connect', path: 'M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71 M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71' }
  ];
